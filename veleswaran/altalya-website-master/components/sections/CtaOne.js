                        ...
                        <div className="title-column col-lg-8 col-md-12">
                            <div className="inner-column">
                                <div className="sec-title light">
                                    ...
                                    <h1>Skills certificate <br />from Altalya</h1>
                                    <Link href="/page-courses" className="theme-btn btn-style-one"><span className="btn-title">Get started now</span></Link>
                                </div>
                            </div>
                        </div>
                        <div className="image-column col-lg-4 col-md-12">
                            <figure className="image"><img src="images/resource/cta.png" title="Altalya" /></figure>
                        </div>
                    </div>
                </div>
            </section>
